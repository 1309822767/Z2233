...
var model_p = 22;
$('.waifu-tool .glyphicon-credit-card').click(function(){
...
$('.waifu-tool .fa-emo-tongue').click(function(){
    showHitokoto();
});
$('.waifu-tool .glyphicon-ice-lolly-tasted').click(function (){
...
$('.waifu-tool .glyphicon-heart-empty').click(function (){
    window.open('https://lolicm.com');
});
...
$('.waifu-tool .glyphicon-camera').click(function(){
...
jQuery(document).ready(function($){
    ...
    $('.waifu-tool .fa-emo-tongue').mouseover(function(){
        showMessage('猜猜我要说些什么？');
    });
    $('.waifu-tool .glyphicon-credit-card').mouseover(function(){
        if(model_p===22) showMessage('要见见我的姐姐嘛'); else showMessage('什么？我的服务不好，要33回来？');
    });
    $('.waifu-tool .glyphicon-ice-lolly-tasted').mouseover(function(){
        showMessage('喜欢换装play吗？');
    });
    $('.waifu-tool .glyphicon-camera').mouseover(function(){
        showMessage('你要给我拍照呀？一二三～茄子～');
    });
    $('.waifu-tool .glyphicon-heart-empty').mouseover(function(){
        showMessage('想知道更多关于我的事么？');
    });
    $('.waifu-tool .glyphicon-remove').mouseover(function(){
